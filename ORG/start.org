...
Подскажите пожалусто, как заменить одиночнуя обратную косую черту "\"
в строке на другой символ?
если
(replace-regexp-in-string "\\" "_" "foo\bar" t t)
приводит к ошибке
    (invalid-regexp "Trailing backslash")
а
(replace-regexp-in-string "\\\\" "_" "foo\\bar" t t)
>>"foo_bar"
(replace-regexp-in-string (regexp-quote "\\") "_" "foo\\bar")
>>"foo_bar"
естественно работают для двойного слеша


     #+BEGIN: block-update-time :format "on %m/%d/%Y at %H:%M"
     Last block update at: on 06/26/2020 at 21:33
     #+END:
