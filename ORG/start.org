...
#+RESULTS:
| lambda | nil | (interactive) | (setq region-text (buffer-substring (region-beginning) (region-end))) | (evil-normal-state) | (evil-previous-line) | (outshine-insert-heading) | (backward-char) | (save-excursion (insert  ) (insert region-text) (insert  :)) |
